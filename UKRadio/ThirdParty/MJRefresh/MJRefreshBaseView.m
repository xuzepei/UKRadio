...
- (UIActivityIndicatorView *)activityView
{
    if (!_activityView) {
        ...
        activityView.color = [UIColor colorWithRed:246/255.0 green:193/255.0 blue:11/255.0 alpha:1.0];
...
- (void)layoutSubviews
{
    ...
    // 2.指示器;
    self.activityView.center = CGPointMake([UIScreen mainScreen].bounds.size.width/2.0,self.arrowImage.center.y);
}
